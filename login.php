          ...
          <div class="formspacer">
            ...
            <div class="signupform">
              ...
              <form action="signupconfigs.php" class=" df-c" method="post">
                ...
                <div class="input__container" id="input">
                  <div class="input-txt-div">
                    <input type="text" name="username" placeholder="Choose a username" autocomplete="off" id="un">
                    <label for="un">
                      <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          fill="#BDBDBD" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M10.0001 13.625C8.57374 13.625 7.17251 14.0005 5.93728 14.7137C4.70205 15.427 3.67634 16.4528 2.96327 17.6881C2.79071 17.9871 2.40848 18.0896 2.10953 17.917C1.81058 17.7444 1.70812 17.3622 1.88068 17.0632C2.70345 15.6379 3.88696 14.4542 5.31223 13.6312C6.7375 12.8083 8.3543 12.375 10.0001 12.375C11.6459 12.375 13.2627 12.8083 14.688 13.6312C16.1132 14.4542 17.2968 15.6379 18.1195 17.0632C18.2921 17.3622 18.1896 17.7444 17.8907 17.917C17.5917 18.0896 17.2095 17.9871 17.0369 17.6881C16.3239 16.4528 15.2982 15.427 14.0629 14.7137C12.8277 14.0005 11.4265 13.625 10.0001 13.625Z"
                          fill="#BDBDBD" />
                      </svg> username
                ...
                <div class="input__container" id="input">
                  <div class="input-txt-div">
                    <input type="email" name="email" placeholder="Enter your email" autocomplete="off"
                      id="email_signup"><label for="un1">
                      <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M1.875 4.875C1.875 4.52982 2.15482 4.25 2.5 4.25H17.5C17.8452 4.25 18.125 4.52982 18.125 4.875V15.5C18.125 15.8315 17.9933 16.1495 17.7589 16.3839C17.5245 16.6183 17.2065 16.75 16.875 16.75H3.125C2.79348 16.75 2.47554 16.6183 2.24112 16.3839C2.0067 16.1495 1.875 15.8315 1.875 15.5V4.875ZM3.125 5.5V15.5H16.875V5.5H3.125Z"
                          fill="#BDBDBD" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M2.03928 4.45268C2.27253 4.19823 2.66788 4.18104 2.92233 4.41428L10 10.9021L17.0777 4.41428C17.3321 4.18104 17.7275 4.19823 17.9607 4.45268C18.194 4.70713 18.1768 5.10248 17.9223 5.33573L10.4223 12.2107C10.1834 12.4298 9.81663 12.4298 9.57768 12.2107L2.07768 5.33573C1.82323 5.10248 1.80604 4.70713 2.03928 4.45268Z"
                          fill="#BDBDBD" />
                ...
                <div class="input__container" id="input">
                  <div class="input-txt-div">
                    <input type="password" name="confirm_password" placeholder="Confirm your password"
                      autocomplete="off" id="confirm_pw"><label for="un3">
                      <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M10 10.5C9.48223 10.5 9.0625 10.9197 9.0625 11.4375C9.0625 11.9553 9.48223 12.375 10 12.375C10.5178 12.375 10.9375 11.9553 10.9375 11.4375C10.9375 10.9197 10.5178 10.5 10 10.5ZM7.8125 11.4375C7.8125 10.2294 8.79188 9.25 10 9.25C11.2081 9.25 12.1875 10.2294 12.1875 11.4375C12.1875 12.6456 11.2081 13.625 10 13.625C8.79188 13.625 7.8125 12.6456 7.8125 11.4375Z"
                          fill="#BDBDBD" />
  ...
  <div class="footer container center ">
    <div class="df fx-s">
      ...
      <div class="df-c footer-box">
        ...
        <p class="df-c">
          <a href="">Management & Consulting</a><a href="">Software Development</a><a href="">Digital Marketing</a><a
            href="">Data Manipulation</a>
        </p>
      </div>
      <div class="df-c footer-box">
        <div class="title-bold">

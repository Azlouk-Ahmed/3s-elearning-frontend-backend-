    ...
    <div class="header container bg">
      ...
      <nav class="nav--bar df container">
        ...
        <div class="links df" id="links">
          <a href="landing.php">Home</a><a href="about.php">About Us</a><a href="courses.php">Course</a
...
<div class="container center">
    ...
    <form action="addcourse.php?email=<?php echo urlencode($email); ?>" class="df-c container" enctype="multipart/form-data" style="width: 67vh;" method="POST">
    <div class="input-txt-div">
    ...
    padding: 12px 17px;
    display: flex;
" accept="image/*" name="image" placeholder="Image URL" autocomplete="off" required>
    ...
    <div class="input-txt-div">
        <input type="number" id="places" placeholder="Amount" name="places" required>
        <label for="places">Places</label>
    </div>

    <div class="input-txt-div">
        <input type="number" id="lessons" placeholder="Amount" name="lessons" required>
        <label for="lessons">Lessons</label>
    </div>

    <div class="input-txt-div">
        <input type="number" id="duration" placeholder="Amount" name="duration" required>
    ...
    if ($result_courses->num_rows > 0) {
        while ($row = $result_courses->fetch_assoc()) {
            ...
            <tr>
                ...
                <td class="df">
                        <a href="modify_course.php?id=<?php echo $row['id']; ?>&email=<?php echo urlencode($email); ?>"> <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="#8B54FF" xmlns="http:
...
<path d="M21 21H12" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <a href="delete_course.php?id=<?php echo $row['id']; ?>&email=<?php echo urlencode($email); ?>"><svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="red" xmlns="http:

    ...
    if ($result_courses->num_rows > 0) {
        while ($row = $result_courses->fetch_assoc()) {
            ...
            <tr>
                ...
                <td class="df">
                        <a href="modify_course.php?id=<?php echo $row['id']; ?>&email=<?php echo urlencode($email); ?>"> <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="#8B54FF" xmlns="http://www.w3.org/2000/svg">
...
<path d="M21 21H12" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <a href="delete_course.php?id=<?php echo $row['id']; ?>&email=<?php echo urlencode($email); ?>"><svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="red" xmlns="http://www.w3.org/2000/svg">

...
?>
  ...
  <nav class="nav--bar df container">
      ...
      <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http:
        ...
        <div class="night-mode-button">
          ...
          <label for="night-mode" class="label">
            <svg  class="fa-moon"  version="1.1" id="Capa_1" xmlns="http:
    ...
    <svg  width="30px" class="fa-sun" version="1.1" id="Capa_1" xmlns="http:
    ...
    <div class="page container center">
      <div class="df-c">
        ...
        <a class="title2" href="landing.php">home > course</a>
    </div>
            ...
            <ul class="df-c mt4">
                <li ><input id="beginner" class="inp-cbx" type="checkbox" style="display: none">
                  <label class="cbx" for="beginner">
                    ...
                    <ul class="df-c mt1">
                        <li>
                          <input id="cbx2" class="inp-cbx" type="checkbox" style="display: none">
                  <label class="cbx" for="cbx2">
                    ...
                    <span>Design</span>
                        ...
                        <li>
                          <input id="cbx3" class="inp-cbx" type="checkbox" style="display: none">
                  <label class="cbx" for="cbx3">
                    ...
                    <span>Development</span>
                        ...
                        <li>
                          <input id="cbx4" class="inp-cbx" type="checkbox" style="display: none">
                  <label class="cbx" for="cbx4">
                    ...
                    <span>Photography</span>
                        ...
                        <li><input id="cbx5" class="inp-cbx" type="checkbox" style="display: none">
                        ...
                        <li><input id="cbx6" class="inp-cbx" type="checkbox" style="display: none">
                        ...
                        <li><input id="cbx7" class="inp-cbx" type="checkbox" style="display: none">
                        ...
                        <li><input id="cbx8" class="inp-cbx" type="checkbox" style="display: none">
                        ...
                        <li><input id="cbx9" class="inp-cbx" type="checkbox" style="display: none">
    ...
    <div class="c-right">
        <div class="header ftt container df">
            <div class="df">Showing <span id="courseCount">12</span> Of <span id="totalCount">16</span> Result</div>
            <div class="df">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http:
                    ...
                    Grid 
                    <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http:
    ...
    <div class="df jc-c">
      ...
      <div class="badg-box ta-c"><svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http:
